<template>
  <button
    :disabled="productNumber === 0 && !basketOpen"
    @click="toggleBasketOpen"
    class="basket"
  >
...
export default {
  ...
  setup() {
    ...
    const toggleBasketOpen = () => commit('common/setBasketOpen', !basketOpen.value)
...
.basket {
  ...
  &__count {
    top: -5px;
    right: -5px;
    padding: $spacing-sm / 2 $spacing-sm / 2 $spacing-sm / 4;
